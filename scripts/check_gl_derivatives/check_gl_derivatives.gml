...
///
/// Returns <true> if GL_OES_standard_derivatives was successfully enabled, <false> otherwise
...
//Use a shader to determine if GL_OES_standard_derivatives was successfully enabled (shader code below)
surface_set_target(_surface);
shader_set(shdDerivativesCheckCompatibility);
